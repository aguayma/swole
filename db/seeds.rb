...
product5 = Product.create(title: 'Turbo Socks',price: 40,description: description, picture: 'https://s3-us-west-2.amazonaws.com/becasted-static-assets/hackathon+images/socks.png')
