...
jacket = 'The Windrunner became the face of Nike apparel in 1978, at a time when the company was known for its footwear. Today, this ultimate running jacket is still as relevant and exciting as it was back then. In its long history, the Nike Windrunner has stayed true to its principles with 26-degree chevron styling, excellent breathability and unparalleled weather resistance.'
socks = 'A unique stitching pattern in the heel creates a snug fit that helps prevent the sock from sliding and promote long-lasting comfort.'
...
product5 = Product.create(title: 'Turbo Socks',price: 2,description: socks, picture: 'https://s3-us-west-2.amazonaws.com/becasted-static-assets/hackathon+images/socks.png')
...
product10 = Product.create(title: 'Wind Breaker',price: 40,description: jacket, picture: 'https://s3-us-west-2.amazonaws.com/becasted-static-assets/hackathon+images/windbreaker.jpg')
